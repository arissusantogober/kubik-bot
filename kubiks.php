...
/**
 * @Author: King Bitcoins
 * @Date:   2017-12-11 17:01:26
 * @Last Modified by:   Aris Susanto
 * @Last Modified time: 2018-08-17 15:13:34
*/


##############################################################################################################
$config['deviceCode'] 		= '866763033440377';
$config['tk'] 				= 'ACGoxTSt_VhA_I5NgMsRJO1jWn0fabSkEzZxdHRodw';
$config['token'] 			= '078fK9leJosn3_jt9l2x77bDKRYDQ5to7XZFwDXCS8itP3xNvqO2bF3eMThtnxyNpdsBmb6WVdmMOaM';
$config['uuid'] 			= '956790ac79294c5d833c2ec7099c7007';
$config['sign'] 			= '357416758bfadcdd0f675ad5a2d6656c';
$config['android_id'] 		= '66b34bffae94b51a';
##############################################################################################################
...
require_once("sdata-modules.php");
/**
 * @Author: Aris Susanto Gober
 * @Date:   2017-12-11 17:01:26
 * @Last Modified by:   King Bitcoins
 * @Last Modified time: 2018-08-17 15:13:34
*/
